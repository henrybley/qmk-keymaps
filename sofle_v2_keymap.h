...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
        IIII, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,         KC_F6, KC_F7, KC_F8, KC_F9, RGB_MOD, RGB_TOG,
        IIII, IIII, IIII, KC_LBRC, KC_RBRC, IIII,   IIII, IIII, IIII, IIII, IIII, RGB_CYCLE_COLOR,
        IIII, IIII, IIII, KC_LCBR, KC_RCBR, IIII,   KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, IIII, RGB_SPI,
        IIII, IIII, IIII, IIII, IIII, IIII, ___,    ___, IIII, IIII, IIII, IIII, IIII, RGB_SPD,
